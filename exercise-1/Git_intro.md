...
## GIT ; Is a tool on computer which tracks all changes on the local machine, for example if you change the file git records that changed file and the original file
